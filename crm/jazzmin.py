...
JAZZMIN_SETTINGS: Dict[str, Any] = {
    ...
    "welcome_sign": _("Добро пожаловать в АвтоЗаказ"),

    # Copyright on the footer
    "copyright": "D.G. Soft Ltd",
    ...
    # "order_with_respect_to": ["auth", "core", "core.ConnectWrapper", "core.ConnectSet", "core.ImportTables",],
    ...
    "changeform_format_overrides": {"orders.user": "single", },
    # "orders.ordercar": "single",
